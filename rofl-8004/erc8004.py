...
class Erc8004:
    ...
    def validation_request(self, agent_id: str, validator_address: str):
        ...
        nonce = self.sdk.web3_client.w3.keccak(text=addr + str(tx_count))
        ipfs_cid = self.sdk.ipfs_client.addFeedbackFile({"nonce": nonce.hex()})
        ...
        tx_hash = self.sdk.web3_client.transact_contract(
            ...
            self.sdk.web3_client.w3.to_checksum_address(validator_address),
            token_id,
            f"ipfs://{ipfs_cid}",
            nonce,
        )
